...
if ($stmt->affected_rows > 0) {
    echo "<script>alert('mise a jour  réussie.'); window.location.href='acceuilchercheur.html';</script>";
} else {
    echo  "<script>alert('erreur de mise a jour .'); window.location.href='acceuilchercheur.html';</script>";
}
